...
O arquivo [`categorias-fixas.json`](categorias-fixas.json) lista livros cuja
categoria foi definida manualmente pela editora. Sincronizações futuras de
categorias (por exemplo, alinhamento com as vitrines do site) devem respeitar
essas escolhas e nunca mover esses livros.
